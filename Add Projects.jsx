    ...
    <div className={`app-container ${menuOpen ? 'menu-open' : ''}`}>
      ...
      <aside className={`sidebar ${menuOpen ? 'open' : ''}`}>
        ...
        <div className="sidebar-content">
          <nav className="nav-links">
            ...
            <a href="#" onClick={() => isMobile && toggleMenu()} className="active">Add Project</a>
      ...
      <main className="main">
        ...
        <form className="project-form" onSubmit={handleSubmit}>
          ...
          <input type="text" name="description" placeholder="Brief description" onChange={handleChange} className="description" />
          ...
          <input id="project-code" type="file" name="files" onChange={handleChange} className="upload" /> 
